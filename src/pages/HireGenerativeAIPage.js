...
const genAISolutions = [
    ...
    { title: 'Generative AI Consulting Services', description: 'At Jellyfish Technologies, our experts guide you through GenAI strategy, demystifying the technology and identifying high-impact opportunities for your business vision.' },
        ...
        <div className="py-24 bg-gray-900/50">
            <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="mt-4 text-lg text-gray-400 max-w-4xl mx-auto">
                        Artificial intelligence is now a strategic driver, not just a buzzword. At Jellyfish Technologies, we align AI solutions with business goals, enhancing experiences, optimizing workflows, and delivering measurable, real-world outcomes across industries.
                    </p>
                </div>
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100' : 'opacity-0 -translate-y-5'}`}>
                        At Jellyfish Technologies, we offer flexible and scalable engagement models to help you hire top Generative AI developers based on your project scope, speed, and team structure.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
