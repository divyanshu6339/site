        ...
        <div className="py-24 bg-gray-900/50">
            <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="mt-4 text-lg text-gray-400 max-w-4xl mx-auto">
                        Artificial intelligence has evolved from a trend into a core business enabler. At Jellyfish Technologies, we deliver AI solutions that are purpose-built to align with your strategic goals—enhancing user experiences, streamlining operations, and achieving measurable business outcomes across diverse industries.
                    </p>
                </div>
