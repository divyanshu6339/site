            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100' : 'opacity-0 -translate-y-5'}`}>
                        Jellyfish Technologies offers flexible engagement models for .NET development services, delivering customized solutions that cater to your specific business needs. Discover our engagement models.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-12">
                <motion.div className="md:w-1/2"
                    ...
                    <p className="text-lg md:text-xl mb-6">
                        Jellyfish Technologies provides top-notch .NET developers who build, and optimize various software solutions, from web and cloud applications to IoT, mobile, and desktop apps. We offer quick access to highly skilled .NET programmers.
                    </p>
