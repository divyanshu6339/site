...
const exploreHealthcareSolutions = [
    ...
    { number: '09', title: 'Healthcare Consulting', description: 'Jellyfish Technologies offers health software consulting services, which include failproof IT strategy plans and innovative tech structures for healthcare providers, medical devices, and pharmaceutical companies. Our prompt analysis of your business allows us to design secure and efficient software solutions, enhancing operations.' }
];
...
const whyChooseUsHealthcare = [
    ...
    { title: 'Enhanced Interoperability', description: 'We at Jellyfish Technologies develop web, desktop, and mobile applications for healthcare management that enhance interoperability, streamline clinical workflows, and improve doctor-patient communications. Our solutions allow patients and medical providers to seamlessly exchange health-related information, track patient data, and more.' },
    ...
    { title: 'Healthcare Mobile Apps', description: 'Jellyfish Technologies offers a diverse range of healthcare mobile app development, including practice management, medical device data collection, drug inventory tracking, hospital management, appointment scheduling, tracking, patient engagement, medical billing, and medical diagnosis. Our software solutions address specific needs across the healthcare spectrum.' },
...
const engagementModelsHealthcare = [
    { title: 'Dedicated Team', description: "Jellyfish Technologies’ dedicated team model functions as an Offshore Development Center (ODC), delivering a tailored approach. This specialized center works exclusively on the client’s project, ensuring cost-effectiveness, scalability, optimized outcomes, efficiency, and high-quality standards.", points: ['Client-Centric Team Formation', 'Direct Reporting And Transparency', 'Scalability And Flexibility', 'Quality And Efficiency'] },
    { title: 'Team Augmentation', description: 'Jellyfish Technologies offers a team augmentation approach and access to top-notch UI/UX design services tailored to your specific needs. Ideal for short-term support or filling skill gaps, this model provides flexibility and immediate access to the expertise required.', points: ['Tailored Expertise', 'Seamless Integration', 'Cost-Effective Solution', 'Transparent Communication'] },
      ...
      <div ref={ref} className="py-24 bg-gray-900/50">
        <div className="w-full px-4 sm:px-6 lg:px-8 text-center">
          <h2 className={`text-4xl md:text-5xl font-bold mb-4 transition-all duration-700 ease-out ${isVisible ? 'opacity-100' : 'opacity-0 -translate-y-5'}`}>
              Why Choose Jellyfish Technologies as a Healthcare Software Development Company?
          </h2>
