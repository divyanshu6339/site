...
const faqsReactNative = [
    ...
    { q: 'How long does it take to build an app if we hire React Native developers from Jellyfish Technologies?', a: 'The timeline depends on the app\'s complexity. A simple MVP can be built in 2-3 months. A full-featured app for both platforms typically takes 4-8 months. Our streamlined process and expert developers help to accelerate this timeline.' },
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100' : 'opacity-0 -translate-y-5'}`}>
                        Jellyfish Technologies offers flexible engagement models for React Native development services, providing customized solutions. Discover the ideal model for your project.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
