...
const userGuideContentNextJs = {
    ...
    'Where to Find Next.js Developers': {
        ...
        points: [
            ...
            { title: 'Development Agencies', text: 'Hiring a Next.js development company or consultants from agencies like Jellyfish Technologies allows you to leverage a team of skilled developers with expertise in Next.js and related technologies.' },
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100' : 'opacity-0 -translate-y-5'}`}>
                        Jellyfish Technologies offers flexible engagement models for Next.js development services, providing customized solutions for your business requirements. Explore the best fit for your project.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
