...
const whatYouGetTypeScript = [
    ...
    { title: 'Consistent Delivery', description: 'At Jellyfish Technologies, we prioritize timely and consistent project delivery without compromising quality. Our TypeScript development team uses Agile methodologies to ensure seamless progress, meeting deadlines while delivering value-driven TypeScript solutions. We focus on continuous improvement and adaptability, making your projects future-proof.' },
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className={`mt-4 max-w-3xl mx-auto text-lg text-gray-400 transition-all duration-700 ease-out delay-150 ${isVisible ? 'opacity-100' : 'opacity-0 -translate-y-5'}`}>
                        Jellyfish Technologies offers flexible engagement models for TypeScript development services, designed to provide tailored solutions. Explore the ideal model for your project.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
